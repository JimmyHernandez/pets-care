        ...
        body: SafeArea(
          ...
          //
              ...
              padding: EdgeInsetsDirectional.fromSTEB(95, 12, 12, 12),
                child: Column(
                        children: <Widget>[
                          CareListItem("Understand Your Pet's Nutritional Needs: Different pets have different dietary requirements. Cats, dogs, birds, and reptiles all have unique nutritional needs. Consult with your veterinarian or do some research to understand what's best for your specific pet."), SizedBox(height: 12), // Add space here
